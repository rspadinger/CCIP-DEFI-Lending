...
//@note add required task parameters
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    //@note get address of deployed contract
    const senderContract = await senderFactory.attach(sender)

    //console.log(destChainSelector, protocol, bnmTokenAddress, amount)

    const sendTokensTx = await senderContract.sendMessage(destChainSelector, protocol, bnmTokenAddress, amount, {gasLimit: 40000})
